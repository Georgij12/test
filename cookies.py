...
driver= webdriver.Chrome(executable_path="C:/Users/grase/Downloads/chromedriver_win32/chromedriver")
...
while True:
    cookie.click()
    # items=driver.find_element(By.XPATH,"/html/body/div[4]/div[5]/div")
